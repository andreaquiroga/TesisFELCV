...
person_role = PersonRole.create([{text: "Victima"}, {text: "Agresor"}, {text: "Denunciante"}, {text: "Testigo"}, {text: "Persona aprehendida"}, {text: "Persona arrestada"}])
user_status = UserStatus.create([{text: "Activo"}, {text: "Inactivo"}, {text: "Vacaciones"}, {text: "Baja medica"}])
admin = User.new(email: "felcv.cochabamba@gmail.com", password: "administrador", password_confirmation:"administrador", role: roles.first.name, ci: 00000, name: "admin", paternal_last_name: "admin", maternal_last_name: "admin", grade: "CORONEL", phone: "4000000", mobile: "7000000")
